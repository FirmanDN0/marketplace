...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight">Buat Kategori</h1>
    </div>
        ...
        <div class="p-6">
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-4">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit" class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white px-6 py-2.5 rounded-2xl font-bold text-sm transition-all shadow-lg shadow-blue-500/15">Buat Kategori</button>
