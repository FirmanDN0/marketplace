...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('admin.categories.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition flex items-center gap-2">
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="text-left px-5 py-3 font-semibold text-gray-600">Parent</th>
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-5 py-3 text-gray-500">{{ optional($cat->parent)->name ?? 'Root' }}</td>
