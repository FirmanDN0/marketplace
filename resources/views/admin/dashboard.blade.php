...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    @php $statCards = [
        ['label' => 'Total Users', 'value' => number_format($stats['total_users']), 'sub' => '+12% this month', 'subColor' => 'text-green-600', 'icon' => 'fa-users', 'iconBg' => 'bg-blue-100 text-blue-600', 'borderColor' => 'border-blue-200'],
        ['label' => 'Active Services', 'value' => number_format($stats['active_services']), 'sub' => '+5% this month', 'subColor' => 'text-green-600', 'icon' => 'fa-briefcase', 'iconBg' => 'bg-green-100 text-green-600', 'borderColor' => 'border-green-200'],
        ['label' => 'Total Revenue', 'value' => 'Rp '.number_format($stats['total_revenue'], 0, ',', '.'), 'sub' => '+18% this month', 'subColor' => 'text-green-600', 'icon' => 'fa-dollar-sign', 'iconBg' => 'bg-emerald-100 text-emerald-600', 'borderColor' => 'border-emerald-200'],
        ['label' => 'Pending Approvals', 'value' => $stats['pending_orders'], 'sub' => '+2% from yesterday', 'subColor' => 'text-orange-500', 'icon' => 'fa-clock', 'iconBg' => 'bg-orange-100 text-orange-600', 'borderColor' => 'border-orange-200'],
    ]; @endphp
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-6 py-4 text-sm font-semibold text-gray-800">
                        @if($user->isProvider() && $user->profile)
                            ${{ number_format(($user->profile->total_earnings ?? 0) / 15000, 0) }}
                        @else
                            -
                        @endif
                    </td>
