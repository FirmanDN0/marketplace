            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="text-left px-5 py-3 font-semibold text-gray-600">Service</th>
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-5 py-3 text-gray-700">{{ optional($order->customer)->name }}</td>
                    <td class="px-5 py-3 text-gray-700">{{ optional($order->provider)->name }}</td>
                    ...
                    <td class="px-5 py-3"><a href="{{ route('admin.orders.show', $order->id) }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View</a></td>
                </tr>
                @empty
