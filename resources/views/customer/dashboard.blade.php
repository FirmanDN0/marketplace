...
{{-- Wallet Banner --}}
<div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600">{{ optional($order->provider)->name }}</td>
                    <td class="px-6 py-4">
                    ...
                    <td class="px-6 py-4 text-sm font-semibold text-gray-800">Rp {{ number_format($order->price, 0, ',', '.') }}</td>
