                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 6px rgba(0,0,0,0.05);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #2563eb, #1d4ed8); padding:32px 32px 24px; text-align:center;">
                            ...
                            <h1 style="color:#ffffff; font-size:22px; margin:0;">Reset Password</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="color:#6b7280; font-size:14px; line-height:1.6; margin:0 0 24px;">
                                Kami menerima permintaan untuk mereset password akun ServeMix kamu. Klik tombol di bawah untuk membuat password baru.
                            </p>

                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $resetUrl }}" style="display:inline-block; background-color:#2563eb; color:#ffffff; text-decoration:none; padding:14px 32px; border-radius:12px; font-size:15px; font-weight:600;">
                                            Reset Password Saya
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="color:#9ca3af; font-size:12px; line-height:1.6; margin:0;">
                                Jika kamu tidak meminta reset password, abaikan email ini. Tidak ada perubahan yang akan terjadi pada akun kamu.
                            </p>
