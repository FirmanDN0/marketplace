...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('messages.index') }}" class="text-gray-400 hover:text-blue-600 transition"><i class="fas fa-arrow-left text-lg"></i></a>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col" style="height: 65vh;">
        ...
        <div class="border-t border-gray-100 p-4 bg-gray-50">
            <form method="POST" action="{{ route('messages.send', $conversation->id) }}" enctype="multipart/form-data" class="flex items-end gap-3">
                @csrf
                <div class="flex-1">
                    <textarea name="message_text" rows="2" required
