...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        @if(auth()->user()->role === 'customer')
            <div class="w-20 h-20 rounded-full bg-blue-100 text-blue-500 flex items-center justify-center mx-auto mb-5">
                <i class="fas fa-hourglass-half text-4xl"></i>
            </div>
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Aplikasi Sedang Diproses!</h1>
            <p class="text-gray-500 mb-8 max-w-md mx-auto">Terima kasih telah melengkapi profil. Tim Admin ServeMix akan meninjau dan memvalidasi aplikasi Anda segera.</p>

            <div class="bg-blue-50/50 border border-blue-100 rounded-xl p-5 mb-8 text-left max-w-sm mx-auto">
                <p class="text-sm font-semibold text-blue-900 mb-2">Apa selanjutnya?</p>
                <p class="text-sm text-blue-800/70">Sambil menunggu persetujuan, Anda masih bisa menggunakan ServeMix sebagai Customer untuk memesan layanan.</p>
            </div>

            <div class="flex items-center justify-center">
                <a href="{{ route('customer.dashboard') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold text-sm transition">
                    Kembali ke Dasbor
                </a>
            </div>
        @else
