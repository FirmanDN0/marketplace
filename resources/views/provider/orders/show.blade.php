...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex items-center gap-4 mb-6 flex-wrap">
        <a href="{{ route('provider.orders.index') }}" class="text-gray-400 hover:text-blue-600 transition"><i class="fas fa-arrow-left text-lg"></i></a>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-5 text-center">
                    <p class="text-sm text-gray-600 mb-4">This order is paid and ready to start.</p>
                    <form method="POST" action="{{ route('provider.orders.start', $order->id) }}">
                        @csrf @method('PATCH')
                        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 rounded-xl font-semibold text-sm transition inline-flex items-center justify-center gap-2">
