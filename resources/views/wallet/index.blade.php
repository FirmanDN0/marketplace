...
<div class="max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg">
            ...
            <div class="text-3xl font-bold mb-4">Rp {{ number_format($profile->balance, 0, ',', '.') }}</div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tr class="hover:bg-gray-50/50">
                    ...
                    <td class="px-5 py-3 text-gray-600">{{ optional($wd->account_details)['name'] ?? '-' }} / {{ optional($wd->account_details)['number'] ?? '-' }}</td>
                    <td class="px-5 py-3">
